           ...
           { home && <div className="home-body-content">
                ...
                <div className="home-body-chat-content" style={{display:'block'}}>  
                    ...
                    <div className="home-body-chat-card-answer">
                        <p className="chat-card-text" style={{textAlign:'center'}}>{answer}</p>
                    </div><br/>  
                    
                </div>
                <div className="home-chat-content">
                    <input type="text" className="chat-input" placeholder="Type your question here..." value={question} onChange={e=>setQuestion(e.target.value)}/>
